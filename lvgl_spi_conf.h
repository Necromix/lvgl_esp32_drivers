...
#else
#define TTOUCH_SPI_HOST    HSPI_HOST
#endif
 ...
 *      TYPEDEFS
 **********************/
#if defined (CONFIG_CUSTOM_SPI_MAX_TRANSFER_SIZE)
#define SPI_BUS_MAX_TRANSFER_SZ (CONFIG_CUSTOM_SPI_MAX_TRANSFER_SIZE)
#else
#define SPI_BUS_MAX_TRANSFER_SZ (8192)
#endif
